...
interface OnboardingMultiSelectCardProps {
  label: string;
  detail?: string;
  selected: boolean;
  onPress: () => void;
...
export function OnboardingMultiSelectCard({
  label,
  detail,
  selected,
  onPress,
  icon: IconComponent,
}: OnboardingMultiSelectCardProps) {
...
const styles = StyleSheet.create({
  ...
  check: {
    width: 22,
    height: 22,
    borderRadius: 6, // Square-like checkbox for multi-select
    borderWidth: 1.5,
